...
use icons::{
  ARROW_DROP_DOWN, ARROW_LEFT, ARROW_RIGHT, BOOKMARK, BOOKMARK_BORDER, CHEVRON_LEFT, CHEVRON_RIGHT,
  CLEAR, CONTENT_COPY, DESELECT, DONE_ALL, FIRST_PAGE, INDETERMINATE_CHECK_BOX, INFO, LAST_PAGE,
  LINK, LINK_OFF, PLAY_ARROW, REFRESH, SHUFFLE,
};
